...
struct PQueue {
	...
	PQueue(PStack<T> *head, PStack<T> *tail, PStack<T> *tailRevFrom, PStack<T> *tailRevTo,
	...
	PQueue<T>* step(PStack<T> *head, PStack<T> *tail, PStack<T> *tailRevFrom, PStack<T> *tailRevTo,
		...
		return new PQueue<T>(head, tail, tailRevFrom, tailRevTo, headRevFrom, headRevTo, copied);
	}

	PQueue<T>* create(PStack<T> *head, PStack<T> *tail, PStack<T> *tailRevFrom, PStack<T> *tailRevTo,
		PStack<T> *headRevFrom, PStack<T> *headRevTo, int copied) {
		bool init = tailRevFrom == nullptr;
		...
		int steps = init && tailRevFrom != nullptr ? 4 : 3;
